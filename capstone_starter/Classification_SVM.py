...
print(body_type_df.ethnicity.value_counts())
print(body_type_df.drinks.value_counts())
print(body_type_df.body_type.value_counts())
print(body_type_df.diet.value_counts())
drink_mapping = {"not at all": 0, "rarely": 1, "socially": 2, "often": 3, "very often": 4, "desperately": 5}
smokes_mapping = {"no": 0, "sometimes": 1, "when drinking": 2, "yes": 3, "trying to quit": 4}
drugs = {"never": 0, "sometimes": 1, "often": 2}
diet = {"mostly anything" : 0,
"anything" : 0,
"strictly anything": 0,
"mostly vegetarian": 1,
"mostly other": 2,
...
print("\nAccuracy score: " + str(accuracy_score(body_type_labels_test, prediction)))
